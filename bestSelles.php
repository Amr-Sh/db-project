...
.container{margin-top: 50px;margin-bottom: 30px}
table {
  width:60%;
}
table, th, td {
...
$sql="SELECT products.productName,SUM(orderdetails.quantityOrdered)AS quantity,
      SUM(orderdetails.quantityOrdered*orderdetails.priceEach)AS Earn
