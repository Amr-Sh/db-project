...
.container{margin-top: 50px;margin-bottom:20px;}
table {
  width:60%;
}
table, th, td {
...
<center>
  <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      <input type="number" name="i" min="100" max="5000">
...
$i=1;
$num=$_POST['i'];
$num=htmlspecialchars(trim($num));
if (filter_var($num,FILTER_VALIDATE_INT)) {
  

$sql="SELECT productName,quantityInStock from products where quantityInStock >'$num'";
