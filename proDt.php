...
.container{margin-top: 50px;margin-bottom: 25px}
table {
  width:60%;
}
table, th, td {
...
$sql="SELECT orders.orderNumber,orderdetails.quantityOrdered,customers.customerName
FROM orders , orderdetails ,customers
WHERE  orders.orderNumber=orderdetails.orderNumber
AND orders.customerNumber=customers.customerNumber
AND orderdetails.productCode= '$id'
